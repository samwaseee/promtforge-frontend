...
export default function RegisterPage() {
    ...
    const syncWithBackend = async (firebaseUser: any) => {
        ...
        const response = await fetch(`${API_URL}/api/auth/sync`, {
            ...
            body: JSON.stringify({
                name: formData.name || firebaseUser.displayName, // Fallback to social name if form is empty
                role: formData.role, // Passes the selected UI role!
        ...
        // ✨ Use AuthContext to update the app state globally
