    ...
    <section className="py-24 bg-slate-50 dark:bg-slate-950 transition-colors">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white sm:text-4xl">Engineered for Results</h2>
          <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">Stop wasting tokens on trial and error. Buy the exact instructions you need.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <motion.div 
              ...
              className="bg-white/60 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 p-8 rounded-3xl backdrop-blur-md hover:border-slate-300 dark:hover:border-slate-700 transition-colors shadow-sm dark:shadow-none"
            >
              <div className="bg-slate-100 dark:bg-slate-800/50 w-12 h-12 rounded-xl flex items-center justify-center mb-6">
                {step.icon}
              </div>
