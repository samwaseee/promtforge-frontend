  ...
  return (
    ...
    >
      ...
      <div className="flex-1 py-6 flex flex-col gap-1 px-3 overflow-y-auto overflow-x-hidden scrollbar-hide">
        ...
        {/* COMMON / GLOBAL */}
        <div className="mb-2">
          <p className="px-3 text-[10px] font-bold uppercase tracking-wider text-slate-500 mb-2 opacity-0 group-hover:opacity-100 transition-opacity">
            Overview
          </p>
        ...
        {role === "SELLER" && (
          <div className="mb-2 border-t border-slate-800/50 pt-4 mt-2">
            <p className="px-3 text-[10px] font-bold uppercase tracking-wider text-slate-500 mb-2 opacity-0 group-hover:opacity-100 transition-opacity">
              Store Management
            </p>
      ...
      <div className="p-3 border-t border-slate-800 bg-slate-900/30 flex flex-col gap-1">
        ...
        <button 
          ...
          className="flex items-center gap-4 px-3 py-3 rounded-lg text-red-400 hover:bg-red-500/10 hover:text-red-300 transition-colors whitespace-nowrap w-full mt-2"
        >
